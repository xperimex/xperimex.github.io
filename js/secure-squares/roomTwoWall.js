const s5 = ( sketch )  => {
    ...
    wall_light = new Draggable(400, 400 + 0.5*square_dim, 6, [255,0,0]);
    wall_target = new Draggable(500, 300 + 0.5*square_dim, 6, [0,255,0]);    
    reflected_target = new Draggable(200,250,6,[0,128,0]);
...
let roomTwoWall = new p5(s5, 'roomTwoWall')