const s2 = ( sketch2 ) => {
    ...
    sketch2.setup = function() {
        ...
        target = new Draggable(485, 485, 6, [0,255,0]);
        mirror_center = new Draggable(300, 140, 6, [100,100,100]);
        mirror_rad = new Draggable(180, 140, 6, [100,100,100]);
    ...
    sketch2.draw = function() {
        ...
        if (track_mouse) {
            mouse_angle = Math.atan2(sketch2.mouseY - light.y, sketch2.mouseX - light.x);
        } else {
            mouse_angle = mouse_angle;
        }
        
        var beam = new Ray(light.x, light.y, mouse_angle, 1000);
        // drawRay(beam);
        circleIntersection(mirror_center.x, mirror_center.y, mradius, beam);
...
let alhazenIntro = new p5(s2, 'alhazenIntro')