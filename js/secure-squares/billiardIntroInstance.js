const s1 = ( sketch ) => {
    ...
    function wallIntersect(ray) {
        ...
        if (intersect_t < 0) {
            ...
            // console.log(bounce.px, bounce.py, bounce.dir, bounce.radius)
    ...
    sketch.setup = function() {
        sketch.createCanvas(width2,height2);   
        // background(255);
        // line(0,0,width,0);
        // line(0,0,0,height);
        ...
        wall_light = new Draggable(186, 309, 6, [255,0,0]);
        wall_target = new Draggable(532, 512, 6, [0,255,0]);
        line1 = new Draggable(300, 250, 6, [100,100,100]);
        line2 = new Draggable(200, 200, 6, [100,100,100]);
        
    }

    var track_mouse2 = true;

    sketch.keyPressed = function() {
    if (sketch.keyCode == 49) {
        track_mouse2 = !track_mouse2;
    }
    }
    ...
    sketch.draw = function() {
        ...
        if (track_mouse2) {
            mouse_angle2 = Math.atan2(sketch.mouseY - wall_light.y, sketch.mouseX - wall_light.x);
        } else {
            mouse_angle2 = mouse_angle2;
        }
        ...
        var beam2 = new Ray(wall_light.x, wall_light.y, mouse_angle2, 1000);
...
let billiardsIntro = new p5(s1, 'billiardIntro');