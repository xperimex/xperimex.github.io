const s7 = ( sketch )  => {
    ...
    var last_starting_point = wall_target;
    ...
    for (let x = 0; x < grid_size; x++) {
        for (let y = 0; y < grid_size; y++) {
            ...
            if (x % 2 == 0 && y % 2 == 0) {
                ...
                sketch.stroke(170,0,170);
            } else if (x % 2 == 1 && y % 2 == 0) {
                sketch.stroke(170,170,0);
            } else if (x % 2 == 1 && y % 2 == 1) {
                sketch.stroke(0,170,170);
            }
        ...
        temp_top = [new Point(wall_top[0].x, wall_top[0].y), 
                    new Point(wall_top[1].x, wall_top[1].y)];
        reflection = reflect(temp_left, last_starting_point);
        last_starting_point = reflect(temp_left, last_starting_point);
...
let secureLattice = new p5(s7, 'secureLattice')