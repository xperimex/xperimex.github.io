const s2 = ( sketch2 ) => {
    ...
    sketch2.draw = function() {
        ...
        if (track_mouse) {
            mouse_angle2 = Math.atan2(sketch2.mouseY - light.y, sketch2.mouseX - light.x);
        } else {
    ...
    sketch2.strokeWeight(1);
    sketch2.stroke(0,0,0)
    sketch2.line(light.x - 1000*Math.cos(mouse_angle2), light.y - 1000*Math.sin(mouse_angle2),
        light.x + 1000*Math.cos(mouse_angle2), light.y + 1000*Math.sin(mouse_angle2))
